  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="collapse">
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown" id="ativo"><a href="index.php"> Pedidos</a></li>
<li class="dropdown" id="inativo">
          ...
          <ul id="dropdown_menu" class="dropdown-menu">
            <li id="ativo1"><a href="edicao_usuario.php?cd=<?php echo $_SESSION['cd_usuario'];?>"> Conta</a></li>
...
<div id="adm_pagina" class="col-md-11">
<div class="row">
<center><img src="../images/pedidos.png" style="width:50%;"></center>
<?php 
echo '<hr>'; 
...
if(isset($_POST['mensagem'])){
  ReportarErro($_POST['mensagem'],$_POST['cd']);
}
?>
</div>
...
window.location="index.php?buscar="+buscar;
});
